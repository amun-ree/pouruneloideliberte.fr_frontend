...
angular.module('admdFrontendApp')
  .controller('EndCtrl', function ($scope, $http, $location, $window, $rootScope, $routeParams, CONFIG, angularLoad, $filter, Deputy, Departement, Opinion, base64, Sendmailnumber) {
